...
def home():
    ...
    pushoff_df = pd.read_excel(r'C:\Users\Pooja\OneDrive\Desktop\Final\cleaned_pushoff1.xlsx',sheet_name='Sheet1')
    lowerknee_df = pd.read_excel(r'C:\Users\Pooja\OneDrive\Desktop\Final\cleaned_pushoff.xlsx',sheet_name='Sheet1')
    upperknee_df = pd.read_excel(r'C:\Users\Pooja\OneDrive\Desktop\Final\cleaned_pushoff.xlsx',sheet_name='Sheet1')
    trunk_df = pd.read_excel(r"C:\Users\Pooja\OneDrive\Desktop\Final\cleaned_trunk.xlsx",sheet_name='Sheet1')
